...
public class BasicDocument extends Document 
{
	...
	public int getNumSentences()
	{
		...
		int numSentences = getTokens("[^.!?]+").size();
	...
	public int getNumSyllables(String word){
		...
		List<String> syllables = getTokens("[aeiouAEIOUyY]+");
		
		int numSyllables = syllables.size();
		
		
		//a lone "e" at the end of a word is not considered a syllable unless the word has no other syllables
		
		if( syllables.get(numSyllables-1).equalsIgnoreCase("e") && numSyllables>1  ){
